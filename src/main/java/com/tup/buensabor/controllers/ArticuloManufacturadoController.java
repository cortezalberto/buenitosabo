...
public class ArticuloManufacturadoController
        extends BaseControllerImpl<ArticuloManufacturado, ArticuloManufacturadoDto, ArticuloManufacturadoServiceImpl> {
...
// ESTE LLAMA A L AINTERFAZ CERRADA
    @PreAuthorize("hasAnyAuthority('administrador', 'logistica')")
    @GetMapping("/ranking")
    public ResponseEntity<?>
    ranking(@RequestParam(name = "desde", required = false) Date desde,
            @RequestParam(name = "hasta", required = false) Date hasta) {
        try {
